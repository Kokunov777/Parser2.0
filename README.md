...
# таблица лексемы 
| № | лексема  |тип лексемы| условный код | Сообщение                                  |
|----|-------------------------------|--------------------------------------------|
...
| 12  | Отсутствует (                 | "Ожидается '('"                            |
| 13 | Отсутствует )                 | "Ожидается ')'"                            |
| 14  | Неверный формат аргумента     | "Ожидается вещественное число"             |
| 15 | Отсутствует ,                 | "Ожидается ','"                            |
| 16 | Отсутствует ;                 | "Ожидается ';'"                            |
